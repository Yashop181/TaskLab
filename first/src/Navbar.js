          ...
          <a className="navbar-brand" href="#" style={{ color: 'white' }}> Logo</a>
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="/form" style={{ color: 'white' }}>Home</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#" style={{ color: 'white' }}>Form</a>
              </li>
              <li className="nav-item">
            ...
            <form className="d-flex">
              ...
              <button className="btn btn-outline-success" type="submit">Form</button>
            </form>
          </div>
        </div>
      </nav>
